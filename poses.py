...
def create_pytables_raw_poses_file(poses_file_name, n_cameras, props_markers):
...
def create_pytables_final_poses_file(poses_file_name, n_cameras, props_markers):
    if os.path.exists(poses_file_name):
        os.remove(poses_file_name)
